...
export const updateCarP=(item, index)=>{
    return {type: 'UPDATE_CARP',payload:{item, index}}
}
...
export const addCarModel = (car) => {
    return { type: 'ADD_CAR_MODEL', payload: car }
}

export const addCarReturn = (car) => {
    return { type: 'ADD_CAR_RETURN', payload: car }
}
